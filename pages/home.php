...
<div class="welcome-section">
    <img src="img/hikers-on-trail.jpg" alt="Happy Hikers on a Trail" class="">
    <h1>Welcome to Alabama College Trails!</h1>
</div>
<script src="js/weather.js"></script>
<div class="about-us-section">
    <h2>About Us</h2>
    <p>Alabama College Trails is a club for outdoor enthusiasts who love to explore the beautiful trails of Alabama. Our members come from all walks of life and all levels of experience, but we share a common love for hiking and the great outdoors. Whether you're a seasoned hiker or just starting out, we welcome you to join us on our adventures!</p>
</div>

<section class="featured-hikes">
    <div class="featured-hikes-container">
        <h1 class="featured-hikes-header">Featured Hikes</h1>
        <div class="featured-hikes-row">
            <div class="card">
                <img src="img/Kings_Chair.jpg" alt="King's Chair">
                <img src="img/kingschairmap.png" alt="King's Chair Map">
                <div class="card-body">
                    <h5 class="card-title">King's Chair</h5>
                    <p id="kingsChair-temperature">Loading temperature...</p>
                    <p id="kingsChair-rain">Loading chance of rain...</p>
            ...
            <div class="card">
                <img src="img/Alum_Hollow.jpg" alt="Alum Hollow">
                <img src="img/Alum_Hollow_Map.png" alt="Alum Hollow Map">
                <div class="card-body">
                    <h5 class="card-title">Alum Hollow</h5>
                    <p id="alumHollow-temperature">Loading temperature...</p>
                    <p id="alumHollow-rain">Loading chance of rain...</p>
            ...
            <div class="card">
                <img src="img/Little_River.jpg" alt="Little River Canyon">
                <img src="img/Little_River_Map.png" alt="Little River Canyon Map">
                <div class="card-body">
                    <h5 class="card-title">Little River Canyon</h5>
                    <p id="littleRiver-temperature">Loading temperature...</p>
                    <p id="littleRiver-rain">Loading chance of rain...</p>
            ...
            <div class="card">
                <img src="img/Stone_Cuts.jpg" alt="Stone Cuts Trail">
                <img src="img/Stone_Cuts_Map.png" alt="Stone Cuts Trail Map">
                <div class="card-body">
                    <h5 class="card-title">Stone Cuts Trail</h5>
                    <p id="stoneCuts-temperature">Loading temperature...</p>
                    <p id="stoneCuts-rain">Loading chance of rain...</p>
